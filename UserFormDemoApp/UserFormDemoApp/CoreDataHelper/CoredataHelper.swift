...
class CoredataHelper: NSObject {
    ...
    fileprivate let objectModelName = "UserFormDemoApp"
    fileprivate let objectModelExtension = "momd"
    fileprivate let dbFilename = "UserFormDemoApp.sqlite"
    fileprivate let appDomain = "com.io-pandacode.UserFormDemoApp"
